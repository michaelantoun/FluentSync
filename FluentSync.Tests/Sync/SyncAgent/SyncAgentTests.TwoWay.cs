...
namespace FluentSync.Tests.Sync.SyncAgent
{
    public partial class SyncAgentTests
    {
        ...
        public async Task Sync_TwoWay_Int_NonEmptyLists()
        {
            ...
            source.ShouldBeEquivalentToIgnoringOrder(new List<int> { 5, 4, 9, 6, 10 });
            destination.ShouldBeEquivalentToIgnoringOrder(new List<int> { 5, 4, 9, 6, 10 });
        }
        ...
        public async Task Sync_TwoWay_Int_WithEmptyDestination()
        {
            ...
            source.ShouldBeEquivalentToIgnoringOrder(new List<int> { 5, 4, 9 });
            destination.ShouldBeEquivalentToIgnoringOrder(new List<int> { 5, 4, 9 });
        }
        ...
        public async Task Sync_TwoWay_Int_NonEmptySortedSets()
        {
            ...
            source.ShouldBeEquivalentToIgnoringOrder(new SortedSet<int> { 5, 4, 9, 6, 10 });
            destination.ShouldBeEquivalentToIgnoringOrder(new SortedSet<int> { 5, 4, 9, 6, 10 });
        }
